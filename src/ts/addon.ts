...
interface Addons {
	...
	draws: {
		drawAlphaBox: (x: number, y: number, width: number, height: number, color: RGB, outlineColor: RGB, alpha: number) => void;
		drawAlphaBoxV: (pos: Vector2, width: number, height: number, color: RGB, outlineColor: RGB, alpha: number) => void;
		...
		drawCustomShape: (points: Vector2[], color: RGB, filled: boolean, alpha: number) => void;
		drawDashedLine: (x1: number, y1: number, x2: number, y2: number, lineWidth: number, factor: number, pattern: number, color: RGB, alpha: number) => void;
		drawDashedLineV: (pos1: Vector2, pos2: Vector2, lineWidth: number, factor: number, pattern: number, color: RGB, alpha: number) => void;
	...
	misc: {
		...
		mouseMove: (x: number, y: number) => number;
